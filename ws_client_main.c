...
void generate_html_response(const char *message) {
    ...
    printf("<style>\n");
    printf("body { font-family: 'Helvetica Neue', Arial, sans-serif; margin: 20px; background-color: #FAF1E4; }\n");
    printf("h1 { color: #435334; }\n");
    printf("pre { background-color: #FFFFFF; border: 1px solid #CEDEBD; padding: 10px; border-radius: 5px; }\n");
    printf("</style>\n");
    printf("</head>\n");
    printf("<body>\n");
